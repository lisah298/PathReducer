...
title = r'R17: HO$_2$ + H$_2 \rightarrow$ H$_2$O$_2$ + H (doublet)'
xtitle = 'CN2 [(O1,O2)-(H1,H2,H3)]'
ytitle = 'CN1 [(H1,H2,H3)-(H1,H2,H3)]'
directory ='cn_figs_R17' 
...
irc_path = "/home/christopher/projects/luke_combustion/all_runs/IRC/17_H2O2+H_HO2+H2.d"
...
dist_irc = pd.DataFrame(dist_irc, columns=['O1_O2','O1_H1','O1_H2','O1_H3','O2_H1','O2_H2','O2_H3','H1_H2','H1_H3','H2_H3'])  
...
cn2_irc = coord_num([dist_irc.O1_H1.values, dist_irc.O1_H2.values, dist_irc.O1_H3.values, dist_irc.O2_H1.values, dist_irc.O2_H2.values, dist_irc.O2_H3.values], mu=0.97, sigma=3.0) #sigma =0.97  is exp eq. bond length

#get AIMD data  !!PATH NEEDS TO BE ADAPTED!!
aimd_path = "/home/christopher/projects/luke_combustion/all_runs/R_17/"
...
dist_aimd = pd.DataFrame(dist_aimd, columns=['O1_O2','O1_H1','O1_H2','O1_H3','O2_H1','O2_H2','O2_H3','H1_H2','H1_H3','H2_H3'])
...
cn2_aimd = coord_num([dist_aimd.O1_H1.values, dist_aimd.O1_H2.values, dist_aimd.O1_H3.values, dist_aimd.O2_H1.values, dist_aimd.O2_H2.values, dist_aimd.O2_H3.values], mu=0.97, sigma=3.0) #sigma =0.97  is exp eq. bond length
